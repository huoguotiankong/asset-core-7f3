(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@b31afa6dd7ade95bba32bdf667267730bdd48123/apps/tools/magnet-jun/rules/btlm-in-v8.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v8 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v8 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v8 搜索规则已"+(idx>=0?"更新":"导入")+"：先读取真实搜索表单，再按真实 action/name 请求";
})()
