(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@41500c7a82696d31211c753011f7a75d4b62734c/apps/tools/magnet-jun/rules/bt4g.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT4G 搜索规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT4G 搜索规则内容异常";}
var testRaw="";
...
return "toast://BT4G 搜索规则已"+(idx>=0?"更新":"导入")+"：RSS/XML 接口 + 三镜像回退";
})()