(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@95372c10662719ff2e945bfa6a83dfd7bffd6994/apps/tools/magnet-jun/rules/btlm-in-v9.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v9 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v9 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v9 搜索规则已"+(idx>=0?"更新":"导入")+"：固定 SCDht /search/<关键词> 真实路由，不再使用 WebView";
})()
