(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@2b1209e2f0a9a282843cfd968910262cff298c0c/apps/tools/magnet-jun/rules/duo6-top-v1.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 磁力多 搜索规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://磁力多搜索规则内容异常";}
var testRaw="";
...
return "toast://磁力多 搜索规则已"+(idx>=0?"更新":"导入")+"：真实 /search?word= 后端 + .ssbox 解析";
})()