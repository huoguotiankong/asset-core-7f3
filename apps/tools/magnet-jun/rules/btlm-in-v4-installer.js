(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@a14942dcdc452733cb645ea38b13b4328a2bf2dc/apps/tools/magnet-jun/rules/btlm-in-v4.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v4 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v4 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v4 已"+(idx>=0?"更新":"导入")+"，请返回磁力君重新搜索";
})()
