(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@94641fb7403fab4fc242f4043459c4a5330a0f2c/apps/tools/magnet-jun/rules/btlm-in-v7.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v7 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v7 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v7 搜索规则已"+(idx>=0?"更新":"导入")+"，已改为直接关键词路径，请返回磁力君刷新后重试";
})()
