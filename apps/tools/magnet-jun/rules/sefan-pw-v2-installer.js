(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@4040dd4581028179499191f1caafb76e0100c577/apps/tools/magnet-jun/rules/sefan-pw-v2.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 搜番 v2 搜索规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://搜番 v2 搜索规则内容异常";}
var testRaw="";
...
return "toast://搜番 v2 搜索规则已"+(idx>=0?"更新":"导入")+"：增加前端 JS 搜索入口发现 + 多域回退 + 完整诊断";
})()
