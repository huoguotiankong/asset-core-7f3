(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@2e58894e9be89e91062df94f3b4e8a494aabc9ac/apps/tools/magnet-jun/rules/sefan-pw.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 搜番 搜索规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://搜番搜索规则内容异常";}
var testRaw="";
...
return "toast://搜番 搜索规则已"+(idx>=0?"更新":"导入")+"：运行时识别搜索入口 + JSON/HTML 自适应解析";
})()