(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@af79a20dc7d1d98728bbaf0df1403d30e7a1444f/apps/tools/magnet-jun/rules/btlm-in-v10.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v10 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v10 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v10 搜索规则已"+(idx>=0?"更新":"导入")+"：SCDht 真实 /search/<关键词> 路由 + 40位 InfoHash 直提";
})()