(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@397c78a84fbf22a32d593d95d0c9449739084a96/apps/tools/magnet-jun/rules/btlm-in-v5.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 BT联盟 v5 规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://BT联盟 v5 规则内容异常";}
var testRaw="";
...
return "toast://BT联盟 v5 搜索规则已"+(idx>=0?"更新":"导入")+"，请返回磁力君刷新后重试";
})()
