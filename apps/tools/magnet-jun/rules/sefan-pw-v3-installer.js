(function(){
var ruleUrl="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@5a7cd6cf0c0e04cdfff7436b128ba46db3aa1050/apps/tools/magnet-jun/rules/sefan-pw-v3.json";
var raw="";
try{raw=fetch(ruleUrl);}catch(e){return "toast://下载 搜番 v3 搜索规则失败："+(e.message||e);}
var rule;
try{rule=JSON.parse(raw);}catch(e2){return "toast://搜番 v3 搜索规则内容异常";}
var testRaw="";
...
return "toast://搜番 v3 已"+(idx>=0?"更新":"导入")+"：真实后端 /s?word= + 详情 magnet 解析";
})()