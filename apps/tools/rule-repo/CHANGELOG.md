...
5. 导入麻豆AI Test28101 后返回首页，对应更新提示应消失；麻豆传媒同理。
6. 轻同步、检查版本、图标和普通 `.txt` 原生导入不得退化。

## 历史入口
- RC26 完整记录：`apps/tools/rule-repo/CHANGELOG_RC26_20260825.md`
- RC24 及之前：`apps/tools/rule-repo/CHANGELOG_PRE_RC26_20260825.md`
- RC26 版本目录事故：`docs/INCIDENT_LOCAL_CATALOG_CHECK_STALE_20260825.md`
- RC27 多版本更新状态事故：`docs/INCIDENT_CHANNEL_GROUP_UPDATE_STATUS_20260825.md`
