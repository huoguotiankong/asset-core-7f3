/* 我的规则仓库 Remote Bootstrap v1.5.3 - Stable 3.5.3 */
var RULE_REPO_BOOTSTRAP_VERSION='1.5.3';
...
var RULE_REPO_CONFIG={
 id:'rule-repo',branch:'main',latestPath:'apps/tools/rule-repo/latest.json',minBuild:377,
 repoTemplates:[
 ...
 defaultRelease:{schema:1,id:'rule-repo',name:'我的规则仓库',version:'3.5.3',build:377,ref:'main',modules:[
  ...
  {name:'runtimeContract',path:'apps/tools/rule-repo/releases/3.5.3-rc11/runtime_contract.js'},
  {name:'stablePatch',path:'apps/tools/rule-repo/releases/3.5.3/stable_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.3'}}
};
var RuleRepoBoot={
 ...
 updatePage:function(){setPageTitle('正式版更新');var d=[],m=this.manager(),info=m.info(RULE_REPO_CONFIG),cur=info.current||RULE_REPO_CONFIG.defaultRelease,prev=info.previous||null,cfg=JSON.stringify(RULE_REPO_CONFIG),mgr=RULE_REPO_MANAGER_URL;
  d.push({title:'我的规则仓库',desc:'当前 '+cur.version+' · Build '+cur.build+'\nNative Product 8.0 · 已验证稳定版',img:RULE_REPO_ICON,pic_url:RULE_REPO_ICON,col_type:'icon_1_left_pic',url:'hiker://empty',extra:{lineVisible:false}});
