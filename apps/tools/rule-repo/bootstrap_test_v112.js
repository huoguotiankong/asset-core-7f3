/* 我的规则仓库·测试版 Bootstrap v1.0.12 - 3.5.3-rc1 lineage rebase */
var RULE_REPO_BOOTSTRAP_VERSION='1.0.12-test';
...
var RULE_REPO_CONFIG={
 id:'rule-repo-test',branch:'main',latestPath:'apps/tools/rule-repo/test.json',minBuild:365,
 repoTemplates:[
 ...
 defaultRelease:{schema:1,id:'rule-repo-test',name:'我的规则仓库·测试版',version:'3.5.3-rc1',build:365,ref:'main',modules:[
  ...
  {name:'channelPage',path:'apps/tools/rule-repo/releases/3.5.3-rc1/channel_page.js'},
  ...
  {name:'runtimeContract',path:'apps/tools/rule-repo/releases/3.5.3-rc1/runtime_contract.js'},
  {name:'candidatePatch',path:'apps/tools/rule-repo/releases/3.5.3-rc1/candidate_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.3-rc1'}}
};
var RuleRepoBoot={
