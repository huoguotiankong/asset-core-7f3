/* 我的规则仓库 v3.5.0-rc12 - product home */
(function(R){
R.home=function(){
 setPageTitle(this.productTitle());var d=[],m,items;try{m=this.manifest(false);items=(m.items||[]).map(this.normalizeItem.bind(this));}catch(e){setResult([{title:'暂时无法打开程序库',desc:this.friendlyError(e),url:'hiker://page/ruleRepoUpdates?rule=&simple=true',col_type:'text_center_1',extra:{lineVisible:false}}]);return;}
 ...
 d.push(this.hero('我的规则仓库','海阔视界专属 · 规则管理中心\n云端同步 · 版本管理 · 安全恢复',this.iconOf(repo),'hiker://page/ruleRepoUpdates?rule=&simple=true'));
 this.pushNav(d,'home');
