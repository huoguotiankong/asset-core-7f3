/* 我的规则仓库 3.5.3-rc5 - runtime contract */
(function(R){
R.runtimeContractVersion='1.6.0';
R.assertRuntimeContract=function(){
 var required=['home','categoryPage','searchPage','updatesPage','detailPage','channelPage','historyPage','settingsPage','aboutPage','pushNav','pushSection','pushSpacer','pushEmpty','formatTime','scopeChip','itemCard','selectCard','recentTile','actionIcon','hero','friendlyError','compactInfo','primaryAction','secondaryAction','sectionLine','programLine','metricCard','metricInfo','categoryTile','quickAction','quickAction5','sectionToolbar','safeDecodeKeyword','premiumStatusText','statusLabel','tagChip','pushProgram','categorySplitCell','channelMeta','ruleRepoChannelFallback','channelInstallRaw','channelProductCard','pushChannelBlock','installProbeEnabled','rulePresence','actualStatus','actualInstalled','clearPresenceCache','syncManifest','manifest','items','findById','importRule'];
