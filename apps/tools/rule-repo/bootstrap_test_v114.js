/* 我的规则仓库·测试版 Bootstrap v1.0.14 - 3.5.3-rc2 premium UI */
var RULE_REPO_BOOTSTRAP_VERSION='1.0.14-test';
...
var RULE_REPO_CONFIG={
 id:'rule-repo-test',branch:'main',latestPath:'apps/tools/rule-repo/test.json',minBuild:367,
 repoTemplates:[
 ...
 defaultRelease:{schema:1,id:'rule-repo-test',name:'我的规则仓库·测试版',version:'3.5.3-rc2',build:367,ref:'main',modules:[
  ...
  {name:'premiumUi',path:'apps/tools/rule-repo/releases/3.5.3-rc2/premium_ui.js'},
  {name:'home',path:'apps/tools/rule-repo/releases/3.5.3-rc2/home.js'},
  {name:'category',path:'apps/tools/rule-repo/releases/3.5.3-rc2/category.js'},
  ...
  {name:'runtimeContract',path:'apps/tools/rule-repo/releases/3.5.3-rc2/runtime_contract.js'},
  {name:'candidatePatch',path:'apps/tools/rule-repo/releases/3.5.3-rc2/candidate_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.3-rc2'}}
};
var RuleRepoBoot={
