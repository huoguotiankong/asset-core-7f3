/* 我的规则仓库 Candidate Bootstrap v1.5.1 - isolated preview rc2 */
var RULE_REPO_BOOTSTRAP_VERSION='1.5.1-candidate';
...
var RULE_REPO_CONFIG={
  id:'rule-repo-preview',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',minBuild:351,
  moduleHeaders:{'Cache-Control':'no-cache'},
  defaultRelease:{schema:1,id:'rule-repo-preview',name:'我的规则仓库 Candidate',version:'3.5.0-rc2',build:351,ref:'main',modules:[
