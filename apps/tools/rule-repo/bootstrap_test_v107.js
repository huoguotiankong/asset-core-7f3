/* 我的规则仓库·测试版 Bootstrap v1.0.7 - resilient recovery */
var RULE_REPO_BOOTSTRAP_VERSION='1.0.7-test';
...
var RULE_REPO_CONFIG={
 id:'rule-repo-test',branch:'main',latestPath:'apps/tools/rule-repo/test.json',minBuild:358,
 repoTemplates:[
 ...
 defaultRelease:{schema:1,id:'rule-repo-test',name:'我的规则仓库·测试版',version:'3.5.0-rc8',build:358,ref:'main',modules:[
  ...
  {name:'candidatePatch',path:'apps/tools/rule-repo/releases/3.5.0-rc8/candidate_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.0-rc8'}}
};
var RuleRepoBoot={
