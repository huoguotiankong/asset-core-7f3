/* 我的规则仓库·测试版 Bootstrap v1.0.0 */
var RULE_REPO_BOOTSTRAP_VERSION='1.0.0-test';
...
var RULE_REPO_CONFIG={
  id:'rule-repo-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/tools/rule-repo/test.json',minBuild:351,
  moduleHeaders:{'Cache-Control':'no-cache'},
  defaultRelease:{schema:1,id:'rule-repo-test',name:'我的规则仓库·测试版',version:'3.5.0-rc2',build:351,ref:'main',modules:[
    ...
    {name:'detail',path:'apps/tools/rule-repo/releases/3.5.0-rc2/detail.js'},
    ...
    {name:'candidatePatch',path:'apps/tools/rule-repo/releases/3.5.0-rc2/candidate_patch.js'}
  ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.0-rc2'}}
};
var RuleRepoBoot={
