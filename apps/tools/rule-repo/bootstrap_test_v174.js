/* 我的规则仓库 Test Bootstrap v1.7.4 - RC37 Detail On-Demand */
(function(){
if(typeof RULE_REPO_TEST_BOOTSTRAP_URL==='undefined'||!String(RULE_REPO_TEST_BOOTSTRAP_URL||''))RULE_REPO_TEST_BOOTSTRAP_URL='https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@main/apps/tools/rule-repo/bootstrap_test_v174.js';
...
RULE_REPO_BOOTSTRAP_VERSION='1.7.4';
var d=JSON.parse(JSON.stringify(RULE_REPO_CONFIG.defaultRelease));
d.id='rule-repo-test';d.name='我的规则仓库·测试版';d.version='3.5.6-rc37';d.build=427;d.ref='84687fdfa544511bab91c6a8dbaf508b23711227';d.modules=d.modules||[];
d.modules.push({name:'fastHybridControl',path:'apps/tools/rule-repo/releases/test-3.5.6-rc36/fast_hybrid_patch.js'});
d.modules.push({name:'detailChannelBridge',path:'apps/tools/rule-repo/releases/test-3.5.6-rc37/detail_channel_bridge.js'});
d.verify={global:'HikerRuleRepo',property:'version',equals:'3.5.6-rc37'};
RULE_REPO_CONFIG.id='rule-repo-test';RULE_REPO_CONFIG.branch='main';RULE_REPO_CONFIG.latestPath='apps/tools/rule-repo/test.json';RULE_REPO_CONFIG.minBuild=427;RULE_REPO_CONFIG.defaultRelease=d;
