/* 我的规则仓库·测试版 Bootstrap v1.0.29 - 3.5.4-rc6 Single Workspace 13.1 */
var RULE_REPO_BOOTSTRAP_VERSION='1.0.29-test';
...
var RULE_REPO_CONFIG={
 id:'rule-repo-test',branch:'main',latestPath:'apps/tools/rule-repo/test.json',minBuild:383,
 ...
 defaultRelease:{schema:1,id:'rule-repo-test',name:'我的规则仓库·测试版',version:'3.5.4-rc6',build:383,ref:'main',modules:[
  ...
  {name:'runtimeContract',path:'apps/tools/rule-repo/releases/3.5.4-rc6/runtime_contract.js'},
  {name:'candidatePatch',path:'apps/tools/rule-repo/releases/3.5.4-rc6/candidate_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.4-rc6'}}
};
var RuleRepoBoot={
 ...
 updatePage:function(){setPageTitle('测试版更新');var d=[],m=this.manager(),info=m.info(RULE_REPO_CONFIG),cur=info.current||RULE_REPO_CONFIG.defaultRelease,prev=info.previous||null,cfg=JSON.stringify(RULE_REPO_CONFIG),mgr=RULE_REPO_MANAGER_URL;
  d.push({title:'我的规则仓库·测试版',desc:'当前 '+cur.version+' · Build '+cur.build+'\nSingle Workspace 13.1 · 导入桥修复与更大程序区',img:RULE_REPO_ICON,pic_url:RULE_REPO_ICON,col_type:'icon_1_left_pic',url:'hiker://empty',extra:{lineVisible:false}});
