/* 我的规则仓库 Remote Bootstrap v1.5.1 - Stable 3.5.1 */
var RULE_REPO_BOOTSTRAP_VERSION='1.5.1';
...
var RULE_REPO_CONFIG={
 id:'rule-repo',branch:'main',latestPath:'apps/tools/rule-repo/latest.json',minBuild:360,
 repoTemplates:[
 ...
 defaultRelease:{schema:1,id:'rule-repo',name:'我的规则仓库',version:'3.5.1',build:360,ref:'main',modules:[
  ...
  {name:'stablePatch',path:'apps/tools/rule-repo/releases/3.5.1/stable_patch.js'}
 ],verify:{global:'HikerRuleRepo',property:'version',equals:'3.5.1'}}
};
var RuleRepoBoot={
