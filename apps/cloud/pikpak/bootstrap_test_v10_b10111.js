/* PikPak Remote Test Bootstrap 0.1.0-test.10 Build10111 - current Android auth */
...
{name:"core-test10-current-android-auth",path:"apps/cloud/pikpak/releases/0.1.0-test.10-b10111/core_android_patch.js"},
...
{name:"pages-test10-android-auth",path:"apps/cloud/pikpak/releases/0.1.0-test.10-b10111/pages_android_patch.js"},
...
{name:"runtime-test10-android-auth-id",path:"apps/cloud/pikpak/releases/0.1.0-test.10-b10111/runtime_android_patch.js"}
]};
var PikPakBoot={
loadOnly:function(){
    ...
    for(i=0;i<PIKPAK_BOOT_CONFIG.modules.length;i++){
        m=PIKPAK_BOOT_CONFIG.modules[i];url=root+m.path+'?pikpak_release=0.1.0-test.10-b10111';
        require(url,{headers:{'Cache-Control':'no-cache'}},10111);loaded.push({name:m.name,url:url});
    }
    if(typeof PikPakRemoteRuntime==='undefined'||String(PikPakRemoteRuntime.version)!=='0.1.0-test.10'||Number(PikPakRemoteRuntime.build)!==10111)throw new Error('PikPak Test10 Build10111 运行时校验失败');
    return {ok:true,release:{id:'pikpak-test',version:'0.1.0-test.10',build:10111},loaded:loaded};
},
module:function(){this.loadOnly();return PikPakRemoteRuntime.module();},
info:function(){return {managerVersion:'direct-loader',current:{id:'pikpak-test',version:'0.1.0-test.10',build:10111}};},
check:function(){return {ok:true,current:{id:'pikpak-test',version:'0.1.0-test.10',build:10111},hasUpdate:false};},
