/* PikPak Remote Test Bootstrap 0.1.0-test.10 - immutable direct loader */
var PIKPAK_BOOT_CONFIG={id:'pikpak-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',version:'0.1.0-test.10',build:10110,modules:[
...
{name:'core-test9-current-captcha',path:'apps/cloud/pikpak/releases/0.1.0-test.9/core_patch.js'},
...
{name:'pages-test8',path:'apps/cloud/pikpak/releases/0.1.0-test.8/pages_patch.js'},
{name:'pages-test9',path:'apps/cloud/pikpak/releases/0.1.0-test.9/pages_patch.js'},
{name:'pages-test10-web-login',path:'apps/cloud/pikpak/releases/0.1.0-test.10/pages_patch.js'},
...
{name:'runtime-test8-id',path:'apps/cloud/pikpak/releases/0.1.0-test.8/runtime_patch.js'},
{name:'runtime-test9-id',path:'apps/cloud/pikpak/releases/0.1.0-test.9/runtime_patch.js'},
{name:'runtime-test10-web-login',path:'apps/cloud/pikpak/releases/0.1.0-test.10/runtime_patch.js'}]};
var PikPakBoot={
loadOnly:function(){
    ...
    for(i=0;i<PIKPAK_BOOT_CONFIG.modules.length;i++){
        m=PIKPAK_BOOT_CONFIG.modules[i];url=root+m.path+'?pikpak_release=0.1.0-test.10';
        require(url,{headers:{'Cache-Control':'no-cache'}},10110);loaded.push({name:m.name,url:url});
    }
    if(typeof PikPakRemoteRuntime==='undefined'||String(PikPakRemoteRuntime.version)!=='0.1.0-test.10'||Number(PikPakRemoteRuntime.build)!==10110)throw new Error('PikPak Test10 运行时校验失败');
    return {ok:true,release:{id:'pikpak-test',version:'0.1.0-test.10',build:10110},loaded:loaded};
},
module:function(){this.loadOnly();return PikPakRemoteRuntime.module();},
info:function(){return {managerVersion:'direct-loader',current:{id:'pikpak-test',version:'0.1.0-test.10',build:10110}};},
check:function(){return {ok:true,current:{id:'pikpak-test',version:'0.1.0-test.10',build:10110},hasUpdate:false};},
