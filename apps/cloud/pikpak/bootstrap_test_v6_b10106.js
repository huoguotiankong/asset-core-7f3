/* PikPak Remote Test Bootstrap 0.1.0-test.6 - immutable direct loader */
var PIKPAK_BOOT_CONFIG={id:'pikpak-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',version:'0.1.0-test.6',build:10106,modules:[
...
{name:'pages-test6',path:'apps/cloud/pikpak/releases/0.1.0-test.6/pages_patch.js'},
...
{name:'runtime-test6',path:'apps/cloud/pikpak/releases/0.1.0-test.6/runtime_patch.js'}]};
var PikPakBoot={
loadOnly:function(){
    ...
    for(i=0;i<PIKPAK_BOOT_CONFIG.modules.length;i++){
        ...
        url=root+m.path+'?pikpak_release=0.1.0-test.6';
        require(url,{headers:{'Cache-Control':'no-cache'}},10106);
        loaded.push({name:m.name,url:url});
    }
    if(typeof PikPakRemoteRuntime==='undefined'||String(PikPakRemoteRuntime.version)!=='0.1.0-test.6'||Number(PikPakRemoteRuntime.build)!==10106)throw new Error('PikPak Test6 运行时校验失败');
    return {ok:true,release:{id:'pikpak-test',version:'0.1.0-test.6',build:10106},loaded:loaded};
},
module:function(){this.loadOnly();return PikPakRemoteRuntime.module();},
info:function(){return {managerVersion:'direct-loader',current:{id:'pikpak-test',version:'0.1.0-test.6',build:10106}};},
check:function(){return {ok:true,current:{id:'pikpak-test',version:'0.1.0-test.6',build:10106},hasUpdate:false};},
