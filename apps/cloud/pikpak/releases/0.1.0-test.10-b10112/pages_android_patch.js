/* PikPak Test10 Android Pages Patch - Build10112 */
(function(C,P,UI,Pages){
    ...
    Pages.account=function(){
        ...
        if(C.loggedIn()){
            ...
            d.push({title:'Refresh Token 登录',desc:'已有 Refresh Token 时仍可直接恢复 Android 会话；内容不会在页面回显',url:$("",'粘贴 Refresh Token').input(function(){return $.require('pikpak').importRefreshToken(input);}),col_type:'text_1',extra:{lineVisible:false}});
        }
        setResult(d);
    };
