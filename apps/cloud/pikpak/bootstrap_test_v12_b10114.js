/* PikPak Remote Test Bootstrap 0.1.0-test.12 Build10114 - official Web access-first handoff */
var PIKPAK_BOOT_CONFIG={id:'pikpak-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',version:'0.1.0-test.12',build:10114,modules:[
...
{name:"pages-test12-access-first",path:"apps/cloud/pikpak/releases/0.1.0-test.12-b10114/pages_access_first_patch.js"},
{name:"pages-test12-meta",path:"apps/cloud/pikpak/releases/0.1.0-test.12-b10114/pages_meta_patch.js"},
...
{name:"runtime-test12-identity",path:"apps/cloud/pikpak/releases/0.1.0-test.12-b10114/runtime_version_patch.js"}
]};
var PikPakBoot={
loadOnly:function(){
    ...
    for(i=0;i<PIKPAK_BOOT_CONFIG.modules.length;i++){
        m=PIKPAK_BOOT_CONFIG.modules[i];url=root+m.path+'?pikpak_release=0.1.0-test.12-b10114';
        require(url,{headers:{'Cache-Control':'no-cache'}},10114);loaded.push({name:m.name,url:url});
    }
    if(typeof PikPakRemoteRuntime==='undefined'||String(PikPakRemoteRuntime.version)!=='0.1.0-test.12'||Number(PikPakRemoteRuntime.build)!==10114)throw new Error('PikPak Test12 Build10114 运行时校验失败');
    return {ok:true,release:{id:'pikpak-test',version:'0.1.0-test.12',build:10114,variant:'official-web-access-first'},loaded:loaded};
},
module:function(){this.loadOnly();return PikPakRemoteRuntime.module();},
info:function(){return {managerVersion:'direct-loader',current:{id:'pikpak-test',version:'0.1.0-test.12',build:10114,variant:'official-web-access-first'}};},
check:function(){return {ok:true,current:{id:'pikpak-test',version:'0.1.0-test.12',build:10114,variant:'official-web-access-first'},hasUpdate:false};},
