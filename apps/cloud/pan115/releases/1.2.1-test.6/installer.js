...
if(ver===2026092226)return "toast://当前已是115 Test 1.2.1-test.6";
if(ver!==2026092220&&ver!==2026092221&&ver!==2026092222&&ver!==2026092223&&ver!==2026092224&&ver!==2026092225)return "toast://请先覆盖到115 Stable 1.2.0或1.2.1 Test1-Test5再导入本版";
var base="https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@b98b9dd68d3340486d32f25a2f7b53b2bded6f5e/apps/cloud/pan115/modules/";
var search="",fm="",fi="",fo="",rb="",ops="",batch="",picker="";
try{
 search=fetch(base+"search_v2.js");
...
}catch(e2){return "toast://下载115搜索Test6模块失败："+e2.message;}
if(!search||search.indexOf('aid:"1"')<0||search.indexOf("/files/search")<0||search.indexOf("115FileManage")<0)return "toast://搜索V2模块校验失败";
...
function patchHomeInput(fr){
 ...
 if(s===before){
   ...
   if(p>=0){
     var b=Math.max(0,p-800),e=Math.min(s.length,p+1800),seg=s.substring(b,e);
     var old=seg;
...
rule.title="115.简";
rule.author="AI&三鲜汤 · 115.简 Test 1.2.1 搜索热修";
rule.version=2026092226;
var out="hiker://files/cache/115_12106_search_hotfix.json";
