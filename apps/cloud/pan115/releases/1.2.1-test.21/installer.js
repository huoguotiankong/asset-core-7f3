...
if(ver===2026092241)return "toast://当前已是115 Test 1.2.1-test.21";
if(ver!==2026092239&&ver!==2026092240)return "toast://本版仅支持Test19/Test20直接覆盖";
var fm="",store="",history="",folderSearch="";
try{
 ...
 folderSearch=fetch("https://cdn.jsdelivr.net/gh/huoguotiankong/asset-core-7f3@ca715922b976e858afe02555c049a5c1de626f02/apps/cloud/pan115/modules/folder_search_v1.js");
}catch(e2){return "toast://下载Test21模块失败："+e2.message;}
...
if(!folderSearch||folderSearch.indexOf("__PAN115_FOLDER_SEARCH_V1__")<0)return "toast://当前目录搜索模块校验失败";
var toolbar=' d.push({title:"⭐ 常用",col_type:"text_4",url:"hiker://page/115FileShortcuts?rule=115.简&page=fypage"});';
var toolbarNew=toolbar+'\n d.push({title:"▶ 最近",col_type:"text_4",url:"hiker://page/115PlayHistory?rule=115.简&page=fypage"});\n d.push({title:"🔎 搜索",col_type:"text_4",url:"hiker://page/115FolderSearch?rule=115.简&page=fypage&cid="+encodeURIComponent(cid)+"&cname="+encodeURIComponent(cname)+"&trail="+encodeURIComponent(trailJson)});';
if(fm.indexOf(toolbar)<0)return "toast://未找到文件管理工具栏锚点";
...
if(fm.indexOf(oldPlay)<0)return "toast://未找到视频播放锚点";
fm=fm.replace(oldPlay,newPlay);
fm=fm.replace("/*__PAN115_FILE_MANAGE_V9__*/","/*__PAN115_FILE_MANAGE_V11__*/");
try{new Function(fm);new Function(store);new Function(history);new Function(folderSearch);}catch(parseErr){return "toast://Test21语法门禁失败："+String(parseErr.message||parseErr);}
...
replacePage("115FolderSearch","当前目录搜索",folderSearch);
rule.pages=JSON.stringify(pages);
rule.title="115.简";
rule.author="AI&三鲜汤 · 115.简 Test 1.2.1 当前目录搜索";
rule.version=2026092241;
var out="hiker://files/cache/115_12121_folder_search.json";
