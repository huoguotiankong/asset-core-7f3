...
}catch(e3){return "toast://下载 Stable 1.1.0 模块失败："+e3.message;}
if(!offlineRule||offlineRule.indexOf("115Offline")<0) return "toast://Stable 离线模块为空";
if(!resultRule||resultRule.indexOf("115OfflineResult")<0) return "toast://Stable 选集模块为空";
offlineRule=offlineRule.replace(/115\.简·测试/g,"115.简").replace(/Test4/g,"Stable1.1.0");
resultRule=resultRule.replace(/115\.简·测试/g,"115.简").replace(/Test4/g,"Stable1.1.0");
...
rule.title="115.简";
rule.author="AI&三鲜汤 · 磁链播放增强 Stable 1.1.0";
rule.version=2026092111;
try{
...
var out="hiker://files/cache/115_stable_110_rule.json";
