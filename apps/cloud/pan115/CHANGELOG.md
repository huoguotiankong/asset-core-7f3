...
状态：**Stable 1.1.0 / Build 2026092111 / 已实机验证；Test 1.2.0-test.1 / Build 2026092202 / 待实机验证**  
首次纳入：2026-09-21
...
当前状态：`active-test-fast-offline-pending-device-validation`。未通过实机验证前不得覆盖 Stable 1.1.0。
