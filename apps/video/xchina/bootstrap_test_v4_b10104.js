/* xChina Remote Test Bootstrap 0.1.0-test.4 */
var XCHINA_BOOT_CONFIG={id:'xchina-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/xchina/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:10104,defaultRelease:{schema:1,id:'xchina-test',appId:'xchina',name:'小黄书',channel:'test',version:'0.1.0-test.4',build:10104,ref:'main',modules:[{name:'runtime',path:'apps/video/xchina/releases/0.1.0-test.4/runtime.js'}],verify:{global:'XChinaRemoteRuntime',property:'version',equals:'0.1.0-test.4'},notes:'Test4 standalone reader-source protocol consolidation.'}};
var XChinaBoot={
