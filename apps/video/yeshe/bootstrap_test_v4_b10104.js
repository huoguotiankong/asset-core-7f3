/* 夜社短剧 Remote Test Bootstrap 0.1.0-test.4 */
var YESHE_BOOT_CONFIG={
  id:'yeshe-test',branch:'main',latestPath:'apps/video/yeshe/test.json',minBuild:10104,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'yeshe-test',name:'夜社短剧',channel:'test',version:'0.1.0-test.4',build:10104,ref:'f90c745039433bcebb3a65803566096977a981e3',modules:[
    {name:'protocol',path:'apps/video/yeshe/releases/0.1.0-test.3/protocol.js'},
    ...
    {name:'runtime',path:'apps/video/yeshe/releases/0.1.0-test.4/runtime.js'}
  ],verify:{global:'YesheRemoteRuntime',property:'version',equals:'0.1.0-test.4'}}
};
var YesheBoot={
