/* 夜社短剧 Remote Test Bootstrap 0.1.0-test.6 */
var YESHE_BOOT_CONFIG={
  id:'yeshe-test',branch:'main',latestPath:'apps/video/yeshe/test.json',minBuild:10106,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'yeshe-test',name:'夜社短剧',channel:'test',version:'0.1.0-test.6',build:10106,ref:'a9133c7d18998520d5f25d09a17c5d8afa48d27e',modules:[
    {name:'protocol',path:'apps/video/yeshe/releases/0.1.0-test.5/protocol.js'},
    {name:'provider',path:'apps/video/yeshe/releases/0.1.0-test.6/provider.js'},
    {name:'playback',path:'apps/video/yeshe/releases/0.1.0-test.1/playback.js'},
    {name:'runtime',path:'apps/video/yeshe/releases/0.1.0-test.6/runtime.js'}
  ],verify:{global:'YesheRemoteRuntime',property:'version',equals:'0.1.0-test.6'}}
};
var YesheBoot={
