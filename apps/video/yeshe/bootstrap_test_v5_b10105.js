/* 夜社短剧 Remote Test Bootstrap 0.1.0-test.5 */
var YESHE_BOOT_CONFIG={
  id:'yeshe-test',branch:'main',latestPath:'apps/video/yeshe/test.json',minBuild:10105,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'yeshe-test',name:'夜社短剧',channel:'test',version:'0.1.0-test.5',build:10105,ref:'60027f3114b539c2e5f2ac760ff3ebd8859e1a6d',modules:[
    {name:'protocol',path:'apps/video/yeshe/releases/0.1.0-test.5/protocol.js'},
    {name:'provider',path:'apps/video/yeshe/releases/0.1.0-test.5/provider.js'},
    {name:'playback',path:'apps/video/yeshe/releases/0.1.0-test.1/playback.js'},
    {name:'runtime',path:'apps/video/yeshe/releases/0.1.0-test.5/runtime.js'}
  ],verify:{global:'YesheRemoteRuntime',property:'version',equals:'0.1.0-test.5'}}
};
var YesheBoot={
 ...
 ],last='',i;for(i=0;i<urls.length;i++)try{require(urls[i],{headers:{'Cache-Control':'no-cache'}},204);if(typeof HikerCloudRemote==='object')return HikerCloudRemote;}catch(e){last=String(e.message||e);}throw new Error('夜社远程模块管理器加载失败：'+last);},
