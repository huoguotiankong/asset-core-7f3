/* 夜社短剧 Remote Test Bootstrap 0.1.0-test.1 */
var YESHE_BOOT_CONFIG={
  ...
  defaultRelease:{
    schema:1,id:'yeshe-test',name:'夜社短剧',channel:'test',version:'0.1.0-test.1',build:10101,
    ref:'c5ef26fb06a13904b6ce9830a179cacdbfa8cb04',
    modules:[
      {name:'protocol',path:'apps/video/yeshe/releases/0.1.0-test.1/protocol.js'},
      ...
      {name:'runtime',path:'apps/video/yeshe/releases/0.1.0-test.1/runtime.js'}
    ],
    verify:{global:'YesheRemoteRuntime',property:'version',equals:'0.1.0-test.1'}
  }
};
var YesheBoot={
  manager:function(){
