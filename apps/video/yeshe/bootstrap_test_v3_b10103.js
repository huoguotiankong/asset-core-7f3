/* 夜社短剧 Remote Test Bootstrap 0.1.0-test.3 */
var YESHE_BOOT_CONFIG={
  id:'yeshe-test',branch:'main',latestPath:'apps/video/yeshe/test.json',minBuild:10103,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'yeshe-test',name:'夜社短剧',channel:'test',version:'0.1.0-test.3',build:10103,ref:'9d68309c4104ff5726d96467d1e8364ef5850698',modules:[
    ...
    {name:'runtime',path:'apps/video/yeshe/releases/0.1.0-test.3/runtime.js'}
  ],verify:{global:'YesheRemoteRuntime',property:'version',equals:'0.1.0-test.3'}}
};
var YesheBoot={
