/* ACFun 0.5.0-test.2 Local-First entry */
var ACFunLocal=(function(){
var VERSION='0.5.0-test.2',BUILD=50002;
var ROOT='hiker://files/rules/asset-core-local/acfun-test/b50002/';
var BUILDER=ROOT+'local_bundle_builder.js';
var BREF='c14350d117c04c513db63bdc44b46d7b252172fa';
var BPATH='apps/video/acfun/releases/0.5.0-test.2/local_bundle_builder.js';
...
function module(){var b=builder(),m=b.load();if(typeof ac!=='object'||String(ac.localFirstVersion||'')!==VERSION||String(ac.storageGuardVersion||'')!==VERSION)throw new Error('ACFun Local-First storage guard runtime 未就绪');ac.localBundleMeta=m;return ac;}
