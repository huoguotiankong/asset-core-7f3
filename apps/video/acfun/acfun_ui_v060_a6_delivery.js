/** ACFun 0.6.0-alpha6 / Build 157 - delivery/settings overlay. */
(function(){
...
ac.settings=function(){
    ...
    d.push({title:'ACFun',desc:'Test 0.6.0-alpha6 · Build 157\nCloud Shell 6.2 · 筛选与资源恢复强化',pic_url:ICON,img:ICON,col_type:'avatar',url:'hiker://home@我的规则仓库||hiker://home'});
    section(d,'常用入口');
    ...
    toggle(d,'极速详情','acfun_fast_detail','1','视频优先复用列表数据。');
    toggle(d,'快速接口','acfun_fast_api','1','复用最近成功的 API Host。');
    toggle(d,'自动弹幕','acfun_auto_danmu','1','播放时自动附加弹幕。');
    ...
    d.push({title:'最近筛选回退',desc:getItem('acfun_v060_a6_filter_fallback','尚无回退记录'),col_type:'text_1',url:'hiker://empty'});
    ...
    d.push({title:'版本边界',desc:'Test 0.6.0-alpha6 · Build 157 · Shell 6.2.0-test\nStable 0.4.9 · Build 149（保持不变）',col_type:'long_text',url:'hiker://empty'});
    setResult(d)
};
ac.build='2026.08.22-v0.6.0-alpha6';
ac.runtimeMode='test-ui-v060-alpha6-shell62';
try{setItem('acfun_test_runtime','0.6.0-alpha6 shell62')}catch(e){}
})();
