/* ACFun Test Bootstrap v6.7.0 - alpha11 playback/comic/audio/cover recovery */
...
ACFUN_BOOTSTRAP_VERSION='6.7.0-test';
ACFUN_BOOTSTRAP_URL='https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/main/apps/video/acfun/bootstrap_test_v067.js?v=6700';
ACFUN_HC_CONFIG={
 id:'acfun-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/acfun/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:162,
 defaultRelease:{schema:1,id:'acfun-test',name:'ACFun',version:'0.6.0-alpha11',build:162,ref:'main',modules:[
  ...
  {name:'runtime-a10',path:'apps/video/acfun/acfun_runtime_v060_a10.js'},
  {name:'recovery-home-a10',path:'apps/video/acfun/acfun_ui_v060_a10_home.js'},
  {name:'fiction-community-detail-a10',path:'apps/video/acfun/acfun_ui_v060_a10_detail.js'},
  {name:'shell-settings-a10',path:'apps/video/acfun/acfun_ui_v060_a10_delivery.js'},
  {name:'runtime-a11',path:'apps/video/acfun/acfun_runtime_v060_a11.js'},
  {name:'current-comic-audio-detail-a11',path:'apps/video/acfun/acfun_ui_v060_a11_detail.js'},
  {name:'shell-settings-a11',path:'apps/video/acfun/acfun_ui_v060_a11_delivery.js'}
 ],verify:{global:'ac',property:'build',equals:'2026.08.22-v0.6.0-alpha11'}}
};

ACFunBoot.legacyLoaderCode=function(){return "require('"+ACFUN_BOOTSTRAP_URL+"',{headers:{'Cache-Control':'no-cache'}},6700);ACFunBoot.loadOnly();";};
ACFunBoot.ensureBaseline=function(m){var info=m.info(ACFUN_HC_CONFIG),cur=info.current||{};if(Number(cur.build||0)<162){var r=m.resetToDefault(ACFUN_HC_CONFIG);if(!r||!r.ok)throw new Error('ACFun测试版迁移0.6.0-alpha11失败：'+((r&&r.error)||'unknown'));setItem('acfun_test_bootstrap_migrated','0.6.0-alpha11');}};
...
ACFunBoot.updatePage=function(){
 ...
 d.push({title:'当前测试版本 '+cur.version,desc:'Build '+cur.build+' · Shell '+ACFUN_BOOTSTRAP_VERSION+'\nAlpha10 实机已确认小说分类与正文恢复，但有声/常规视频/短视频仍无法播放，漫画仍不可阅读；漫画和部分视频封面恢复但首次解密偏慢，短视频/小说/社区等仍有缺图。Alpha11 保留 Alpha10 已恢复的小说正文与分类，只定点重做音视频播放、当前 Shell 漫画章节解析和封面字段兼容。',col_type:'long_text',url:'hiker://empty'});
