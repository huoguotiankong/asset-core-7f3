/* ACFun Web-Native Bootstrap 1.2.0-web3 */
var ACFUN_WEB_BOOTSTRAP_VERSION='1.2.0-web3';
...
var ACFUN_WEB_CONFIG={
 id:'acfun-web',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/acfun/web.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:11003,
 defaultRelease:{schema:1,id:'acfun-web',name:'ACFun · 网页版',version:'1.2.0-web3',build:11003,ref:'main',modules:[
  ...
  {name:"web-native-bridge-base",path:"apps/video/acfun/web/acfun_web_native_v110.js"},
  {name:"web-native-runtime-base",path:"apps/video/acfun/web/acfun_web_native_runtime_fix_v110.js"},
  {name:"web3-native-terminal-fix",path:"apps/video/acfun/web/acfun_web_native_fix_v120.js"}
 ],verify:{global:'ACFunWebNative',property:'build',equals:'2026.08.23-v1.2.0-web3'}}
};
var ACFunWebBoot={
