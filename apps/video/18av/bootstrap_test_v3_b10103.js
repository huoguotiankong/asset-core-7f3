/* 18AV Remote Test Bootstrap 0.1.0-test.3 */
var AV18_BOOT_CONFIG={
  id:'18av',branch:'main',latestPath:'apps/video/18av/test.json',minBuild:10103,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'18av',name:'18AV',channel:'test',version:'0.1.0-test.3',build:10103,ref:'main',modules:[
    {name:'core',path:'apps/video/18av/releases/0.1.0-test.3/core.js'},
    {name:'runtime',path:'apps/video/18av/releases/0.1.0-test.3/runtime.js'}
  ],verify:{global:'AV18RemoteRuntime',property:'version',equals:'0.1.0-test.3'},notes:'18AV Test3: route namespace repair, detail UI and playback adapter repair.'}
};
var AV18Boot={
