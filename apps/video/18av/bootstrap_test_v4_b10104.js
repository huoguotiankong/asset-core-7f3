/* 18AV Remote Test Bootstrap 0.1.0-test.4 */
var AV18_BOOT_CONFIG={
  id:'18av',branch:'main',latestPath:'apps/video/18av/test.json',minBuild:10104,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'18av',name:'18AV',channel:'test',version:'0.1.0-test.4',build:10104,ref:'main',modules:[
    {name:'hotfixBundle',path:'apps/video/18av/releases/0.1.0-test.4/hotfix_bundle.js'}
  ],verify:{global:'AV18RemoteRuntime',property:'version',equals:'0.1.0-test.4'},notes:'18AV Test4 regex-limit hotfix.'}
};
var AV18Boot={
