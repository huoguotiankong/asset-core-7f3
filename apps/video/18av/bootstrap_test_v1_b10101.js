/* 18AV Remote Test Bootstrap 0.1.0-test.1 */
var AV18_BOOT_CONFIG={
  id:'18av-test',branch:'main',latestPath:'apps/video/18av/test.json',minBuild:10101,timeout:12000,moduleHeaders:{'Cache-Control':'no-cache'},
  repoTemplates:[
  ...
  defaultRelease:{schema:1,id:'18av-test',name:'18AV',channel:'test',version:'0.1.0-test.1',build:10101,ref:'main',modules:[
    {name:'core',path:'apps/video/18av/releases/0.1.0-test.1/core.js'},
    {name:'runtime',path:'apps/video/18av/releases/0.1.0-test.1/runtime.js'}
  ],verify:{global:'AV18RemoteRuntime',property:'version',equals:'0.1.0-test.1'},notes:'Initial 18AV Test.'}
};
var AV18Boot={
