/* ACFAN 0.1.0-test.4 provider - rebuilt from acfun 1.9.7 APK route/field evidence */
var ACFANProvider=(function(){
  ...
  function search(kind,q,page){
    page=Math.max(1,Number(page||1));var size=C.pageSize(),p={page:page,pageNum:page,pageSize:size,keyword:q,title:q};
    if(kind==='video'){
