/* ACFAN 0.1.0-test.3 website terminal */
var ACFANPlayback=(function(){
  var C=ACFANCore;
  function bridgeUrl(kind,id,title,chapter){return C.page('acfanT3Bridge',{acf_kind:kind||'video',acf_id:id||'',acf_title:title||'',acf_chapter:chapter||''});}
