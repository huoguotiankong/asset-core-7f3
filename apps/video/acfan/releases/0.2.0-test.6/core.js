/* ACFAN 0.2.0-test.6 core */
var ACFAN6Core=(function(){
  var VERSION='0.2.0-test.6',BUILD=10206;
  ...
  var K={prefix:'acfan_t6_',device:'acfan_t6_device',token:'acfan_t6_token',apiHost:'acfan_t6_api_host',apiHosts:'acfan_t6_api_hosts',apiHostsTs:'acfan_t6_api_hosts_ts',imgDomain:'acfan_t6_img_domain',h5:'acfan_t6_h5',h5Candidates:'acfan_t6_h5_candidates',diag:'acfan_t6_diag',fav:'acfan_t6_fav',history:'acfan_t6_history',search:'acfan_t6_search',pageSize:'acfan_t6_page_size',imageQuality:'acfan_t6_image_quality',playMode:'acfan_t6_play_mode'};
  ...
  return{version:VERSION,build:BUILD,ua:UA,dalvik:DALVIK,h5Default:H5_DEFAULT,staticApiHosts:API_HOSTS,configUrls:CONFIG_URLS,K:K,s:s,clean:clean,html:html,n:n,pick:pick,deep:deep,first:first,arr:arr,merge:merge,uniq:uniq,fmtNum:fmtNum,page:page,param:param,pageNo:pageNo,getH5:getH5,setH5:setH5,readJson:readJson,writeJson:writeJson,favorites:favorites,history:history,isFav:isFav,toggleFav:toggleFav,addHistory:addHistory,searchHistory:searchHistory,saveSearch:saveSearch,removeSearch:removeSearch,clear:clear,diag:diag,getDiag:getDiag,pageSize:pageSize};
})();
