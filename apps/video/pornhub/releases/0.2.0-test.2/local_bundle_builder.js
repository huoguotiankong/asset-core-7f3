/* Pornhub 0.2.0-test.2 standalone Local-First bundle builder */
var PornhubV2LocalBuilder=(function(){
var VERSION='0.2.0-test.2',BUILD=20002,REF='235dbed2a6b3c2bc99b8d7a553fae4394fac524e';
var ROOT='hiker://files/rules/asset-core-local/pornhub-test/b20002/';
var RUNTIME=ROOT+'runtime_bundle.js',META=ROOT+'bundle_meta.json',ASSET_ROOT=ROOT+'assets/';
var PARTS=[
'apps/video/pornhub/releases/0.2.0-test.2/runtime_parts/01_kernel.part',
...
'apps/video/pornhub/releases/0.2.0-test.2/runtime_parts/06b_creator_center.part',
...
var MARKERS={};
MARKERS[PARTS[0]]='Pornhub V2 0.2.0-test.2 standalone Local-First runtime';
...
MARKERS[PARTS[6]]='Pornhub V2 Creator Center 0.2.0-test.2';
MARKERS[PARTS[7]]='Pages.creator=function';
MARKERS[PARTS[8]]='var Runtime={';
var ASSETS=['account.svg','categories.svg','creators.svg','library.svg','icon.svg','shorts.svg','playlist.svg','gifs.svg','local.svg','favorite.svg','official.svg','subscribe.svg','home.svg','feed.svg','search.svg','comment.svg','history.svg','channel.svg','model.svg'];
