/* Pornhub 0.1.1-test.1 Local-First entry */
...
var BREF='d56cf32216e6f8bbf25ba5adca4e1e21ed02d3e9';
var BPATH='apps/video/pornhub/releases/0.1.1-test.1/local_bundle_builder.js';
...
function load(){var x=builder().load(),r=x.runtime;if(!r||typeof r.module!=='function'||String(r.localFirstVersion||'')!==VERSION)throw new Error('Pornhub Local-First runtime 未就绪');return{meta:x.meta,runtime:r};}
