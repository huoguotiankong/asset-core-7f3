/* Shise Remote Test Bootstrap 0.1.0-test.4 */
var SHISE_BOOT_CONFIG={id:'shise-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/shise/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:10104,defaultRelease:{"schema":1,"id":"shise-test","appId":"shise","name":"视色","channel":"test","version":"0.1.0-test.4","build":10104,"ref":"main","baseStable":null,"modules":[{"name":"runtime","path":"apps/video/shise/releases/0.1.0-test.4/runtime.js"}],"verify":{"global":"ShiseRemoteRuntime","property":"version","equals":"0.1.0-test.4"},"promotedFrom":null,"previousTest":{"version":"0.1.0-test.3","build":10103,"release":"apps/video/shise/releases/0.1.0-test.3/release.json"},"notes":"Test4 consolidated runtime rebuild from device feedback."}};
var ShiseBoot={
