/* 黄豆短剧 Native UI Base 1.9.1-test.2 - local assets */
var HuangDouUIV190=(function(){
  var V='1.9.1-test.2';
  function asset(n){var p='hiker://files/cache/asset-core-local/huangdou/19102/'+String(n)+'.svg';try{return fileExist(p)?getPath(p):p;}catch(e){return p;}}
