/* 黄豆短剧 1.9.1-test.2 Local-First composed runtime */
var HuangDouRemoteRuntime=(function(){
  ...
  function module(){
    ...
    c.version='20260824-v1.9.1-test.2-local-first';
  ...
  return{build:'1.9.1-test.2',version:'1.9.1-test.2',delivery:'local-first-2.1.0',module:module};
})();
