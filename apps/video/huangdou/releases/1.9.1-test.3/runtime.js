/* 黄豆短剧 1.9.1-test.3 - Local-First native composed runtime */
var HuangDouRemoteRuntime=(function(){
  var instance=null;
  function module(){
    if(instance)return instance;
    if(typeof HuangDouCoreV182!=='object'||typeof HuangDouUIV190!=='object'||typeof HuangDouPlaybackV190!=='object'||typeof HuangDouContentV190!=='object'||typeof HuangDouDetailV190!=='object')throw new Error('黄豆短剧 Local-First 模块未完整加载');
    var c=HuangDouCoreV182.module(),p=HuangDouPlaybackV190;
    c.version='20260824-v1.9.1-test.3-local-first-native';
  ...
  return{build:'1.9.1-test.3',version:'1.9.1-test.3',delivery:'local-first-native-2.2.0',module:module};
})();
