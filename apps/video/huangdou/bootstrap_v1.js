/* 黄豆短剧 Remote Stable Bootstrap 1.8.2 */
var HUANGDOU_BOOT_VERSION='1.0.0';
...
var HUANGDOU_BOOT_CONFIG={
  ...
  defaultRelease:{schema:1,id:'huangdou',name:'黄豆短剧',version:'1.8.2',build:18201,ref:'main',modules:[{name:'runtime-loader',path:'apps/video/huangdou/releases/1.8.2-test.1/runtime.js'}],verify:{global:'HuangDouRemoteRuntime',property:'build',equals:'1.8.2-test.1'}}
};
var HuangDouBoot={
