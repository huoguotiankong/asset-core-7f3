/* Hanime1 Bootstrap v3 / Test15 recovery */
...
var HANIME_BOOT_CONFIG={id:'hanime1-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/hanime1/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:20015,defaultRelease:{"schema":1,"id":"hanime1-test","name":"Hanime1","version":"2.0.0-test.15","build":20015,"ref":"main","baseVersion":"2.0.0-test.12","modules":[{"name":"recovery15","path":"apps/video/hanime1/releases/2.0.0-test.15/recovery_loader.js"}],"verify":{"global":"HanimePages","property":"build","equals":"2.0.0-test.15"},"notes":"Recovery Test15 loads the exact device-verified Test12 runtime chain through one ES5 recovery loader. Test13/Test14 runtime modules are not loaded."}};
var HanimeBoot={
manager:function(){require(HANIME_BOOT_MANAGER,{headers:{'Cache-Control':'no-cache'}},201);return HikerCloudRemote;},
loadOnly:function(){var r=this.manager().load(HANIME_BOOT_CONFIG);if(!r||!r.ok||typeof HanimePages!=='object')throw new Error('Hanime1 recovery runtime load failed');return r;},
