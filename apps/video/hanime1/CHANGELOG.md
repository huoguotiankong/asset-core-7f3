...
- Test：`2.0.0-test.16` / Build `20016` / Shell `2026082225`。
- Stable 尚未晋级；Test16 为 Recovery15 后的第一块最小增量功能。
...
- 新增模块优先采用 ES5 兼容写法，并在发布 Guard 中扫描反斜杠等已知风险字符；不得只依赖桌面 JS parser 判断完成。
