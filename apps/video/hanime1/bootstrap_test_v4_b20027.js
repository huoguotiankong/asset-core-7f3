/* Hanime1 Shell v4 installer bootstrap / advertised Test build 20027 */
...
var HANIME_BOOT_CONFIG={id:'hanime1-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/hanime1/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:20027,defaultRelease:{"schema":1,"id":"hanime1-test","name":"Hanime1","version":"2.0.0-test.27","build":20027,"ref":"main","baseVersion":"2.0.0-test.26","supersedes":"2.0.0-test.26","modules":[{"name":"recovery27","path":"apps/video/hanime1/releases/2.0.0-test.27/recovery_loader.js"}],"verify":{"global":"HanimePages","property":"build","equals":"2.0.0-test.27"},"notes":"Test27 cloud-repository installer baseline. Fresh/re-imported test shell must enter build >= 20027."}};
var HanimeBoot={
