/* Hanime1 Bootstrap v4 / Test24 updater recovery */
...
var HANIME_BOOT_CONFIG={id:'hanime1-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/hanime1/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:20024,defaultRelease:{"schema":1,"id":"hanime1-test","name":"Hanime1","version":"2.0.0-test.24","build":20024,"ref":"main","baseVersion":"2.0.0-test.23","modules":[{"name":"recovery24","path":"apps/video/hanime1/releases/2.0.0-test.24/recovery_loader.js"}],"verify":{"global":"HanimePages","property":"build","equals":"2.0.0-test.24"},"notes":"Test24 Shell/Bootstrap recovery baseline."}};
var HanimeBoot={
