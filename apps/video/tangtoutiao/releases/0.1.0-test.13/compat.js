/* 汤头条 0.1.0-test.13 Core compatibility / adaptive image pipeline */
var TangTouTiaoCoreV021=(function(){
  var C=TangTouTiaoCoreV020;
  ...
  function image(raw){var u=C.imageCandidate(raw);if(!u)return'';try{setItem('ttt_last_image_policy',JSON.stringify({time:Date.now(),mode:'adaptive-inline-plain-cbc-legacy',url:String(u).substring(0,180)}));}catch(e){}return String(u)+'@js='+IMG_JS;}
  ...
  C.detailItem=function(r,f){var it=od(r,f);if(f&&f.coverRaw){it.coverRaw=f.coverRaw;it.cover=image(f.coverRaw);}else fix(it);return it;};
  ...
  C.imageUrl=image;C.version='0.1.0-test.13';return C;
})();
TangTouTiaoCoreV020=TangTouTiaoCoreV021;
TangTouTiaoCoreV019=TangTouTiaoCoreV021;
try{TangTouTiaoCoreV017=TangTouTiaoCoreV021;}catch(e){}
