/* 汤头条 Remote Test Bootstrap 0.1.0-test.2 / Build 10102 */
var TTT_BOOT_VERSION='0.1.0-test.2';
...
var TTT_BOOT_CONFIG={
  id:'tangtoutiao-test',branch:'main',repoRawRoot:'https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/',latestPath:'apps/video/tangtoutiao/test.json',moduleHeaders:{'Cache-Control':'no-cache'},minBuild:10102,
  defaultRelease:{"schema":1,"id":"tangtoutiao-test","name":"汤头条","version":"0.1.0-test.2","build":10102,"ref":"main","modules":[{"name":"protocol","path":"apps/video/tangtoutiao/releases/0.1.0-test.2/protocol.js"},{"name":"core","path":"apps/video/tangtoutiao/releases/0.1.0-test.2/core.js"},{"name":"ui","path":"apps/video/tangtoutiao/releases/0.1.0-test.2/ui.js"},{"name":"pages","path":"apps/video/tangtoutiao/releases/0.1.0-test.2/pages.js"},{"name":"runtime","path":"apps/video/tangtoutiao/releases/0.1.0-test.2/runtime.js"}],"verify":{"global":"TangTouTiaoRemoteRuntime","property":"version","equals":"0.1.0-test.2"}}
};
var TangTouTiaoBoot={
