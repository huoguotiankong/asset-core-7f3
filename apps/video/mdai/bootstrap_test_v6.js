/* 麻豆AI Remote Test Bootstrap 2.8.0-test.1 */
var MDAI_BOOT_VERSION='2.8.0-test.1';
...
var MDAI_BOOT_CONFIG={
  ...
  moduleHeaders:{'Cache-Control':'no-cache'},minBuild:28001,
  defaultRelease:{"schema":1,"id":"mdai-test","name":"麻豆AI","version":"2.8.0-test.1","build":28001,"ref":"main","modules":[{"name":"core-bridge","path":"apps/video/mdai/releases/2.7.0-test.1/core.js"},{"name":"playback-adapter","path":"apps/video/mdai/releases/2.7.0-test.1/playback.js"},{"name":"ui-base","path":"apps/video/mdai/releases/2.8.0-test.1/ui_base.js"},{"name":"content-pages","path":"apps/video/mdai/releases/2.8.0-test.1/pages_content.js"},{"name":"detail-pages","path":"apps/video/mdai/releases/2.8.0-test.1/pages_detail.js"},{"name":"settings","path":"apps/video/mdai/releases/2.8.0-test.1/settings.js"},{"name":"runtime","path":"apps/video/mdai/releases/2.8.0-test.1/runtime.js"}],"verify":{"global":"MDAIRemoteRuntime","property":"build","equals":"2.8.0-test.1"}}
};
var MDAIBoot={
