/* 麻豆AI 2.7.0-test.2 composed runtime */
var MDAIRemoteRuntime=(function(){
  var instance=null;
  function module(){
    if(instance)return instance;
    if(typeof MDAICoreV263!=='object'||typeof MDAIPlaybackV270!=='object'||typeof MDAIUIBaseV270!=='object'||typeof MDAIContentPagesV270!=='object'||typeof MDAIDetailPagesV270!=='object')throw new Error('麻豆AI 2.7 模块未完整加载');
    var c=MDAICoreV263.module(),p=MDAIPlaybackV270;
    c.version='20260822-v2.7.0-test.2-library-ui';
    ...
    c.settings=function(){return MDAIDetailPagesV270.settings(c,p);};
    c.play=function(seed){return p.play(c,seed);};
    instance=c;return instance;
  }
  return{build:'2.7.0-test.2',version:'2.7.0-test.2',module:module};
})();
