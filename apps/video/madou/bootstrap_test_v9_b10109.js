/* 麻豆传媒 Remote Test Bootstrap 0.1.0-test.9 */
var MADOU_BOOT_CONFIG={
  ...
  defaultRelease:{
    ...
    modules:[
      ...
      {name:'navigationPlaybackPatch',path:'apps/video/madou/releases/0.1.0-test.7/navigation_playback_patch.js'},
      {name:'detailDirectPlaybackPatch',path:'apps/video/madou/releases/0.1.0-test.8/direct_playback_detail_ui.js'},
      {name:'fastDetailPlaybackPatch',path:'apps/video/madou/releases/0.1.0-test.9/fast_detail_playback.js'}
    ],
    verify:{global:'MadouRemoteRuntime',property:'version',equals:'0.1.0-test.9'}
  }
};
var MadouBoot={
  manager:function(){
