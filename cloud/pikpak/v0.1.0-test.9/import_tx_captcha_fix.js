(function(){
    ...
    try{
        clearMyVar('pikpak_v2_verify_url');clearMyVar('pikpak_v2_verify_token');clearMyVar('pikpak_v2_verified_captcha');clearMyVar('pikpak_v2_verify_handoff_done');clearMyVar('pikpak_v2_login_pass');
    }catch(e3){}
    var shell=String(request('https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/2298a6457e731c05e42f647a155999fc8274b809/apps/cloud/pikpak/pikpak_remote_test_v9_b10109.txt')||'');
