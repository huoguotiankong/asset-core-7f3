...
transportPatchPath:'apps/video/javdb/releases/3.9.43-test.2/transport_patch2.js',
...
core:function(call){
  var c=this.ungz(this.get('core',7,'jdb3_cloud_core_3943t2_base3941'));eval(c);
  eval(this.patch(this.patch1Path,'jdb3_patch_3943t2_p1','3.9.42-test.1'));
  eval(this.patch(this.patch2Path,'jdb3_patch_3943t2_p2','3.9.42-test.2'));
  eval(this.patch(this.patch3Path,'jdb3_patch_3943t2_p3','3.9.42-test.3'));
  eval(this.patch(this.patch4Path,'jdb3_patch_3943t2_p4','3.9.42-test.4'));
  eval(this.patch(this.patch5Path,'jdb3_patch_3943t2_p5','3.9.42-test.5'));
  eval(this.patch(this.stablePatchPath,'jdb3_patch_3943t2_stable','3.9.42 Stable'));
  eval(this.patch(this.transportPatchPath,'jdb3_patch_3943t2_transport','3.9.43-test.2'));
  eval(call);
},
customData:function(){
  var s=String(getItem('jdb3_cloud_custom_3943t2_base3941','')||'');
  if(!s){
    s=this.get('custom',5,'jdb3_cloud_custom_head_3943t2_base3941');
    s+=this.remote(this.basePath+'custom_04b.txt','jdb3_custom_3943t2_04b','');
    s+=this.remote(this.basePath+'custom_05.txt','jdb3_custom_3943t2_05','');
    s+=this.remote(this.basePath+'custom_06.txt','jdb3_custom_3943t2_06','');
    s+=this.remote(this.basePath+'custom_07b.txt','jdb3_custom_3943t2_07b','');
    setItem('jdb3_cloud_custom_3943t2_base3941',s);
  }
  return JSON.parse(this.ungz(s));
},
custom:function(key){
  if(key==='javdb3ExternalPlay'){
    var c=this.ungz(this.get('core',7,'jdb3_cloud_core_3943t2_base3941_ext'));eval(c);
    eval(this.patch(this.patch1Path,'jdb3_patch_3943t2_p1_ext','3.9.42-test.1'));
    eval(this.patch(this.patch2Path,'jdb3_patch_3943t2_p2_ext','3.9.42-test.2'));
    eval(this.patch(this.patch3Path,'jdb3_patch_3943t2_p3_ext','3.9.42-test.3'));
    eval(this.patch(this.patch4Path,'jdb3_patch_3943t2_p4_ext','3.9.42-test.4'));
    eval(this.patch(this.patch5Path,'jdb3_patch_3943t2_p5_ext','3.9.42-test.5'));
    eval(this.patch(this.stablePatchPath,'jdb3_patch_3943t2_stable_ext','3.9.42 Stable'));
    eval(this.patch(this.transportPatchPath,'jdb3_patch_3943t2_transport_ext','3.9.43-test.2'));
